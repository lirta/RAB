                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    ...
                                    <?php
                                    $qedit = mysqli_query($koneksi, "SELECT * FROM produk inner join kategori_produk on produk.id_kategori_produk=kategori_produk.id_kategori_produk where id_produk='$_GET[id]'  ");
                                    ...
                                    <form class="form-horizontal m-t-md" action="produck-edit-proses.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select class="form-control m-b" name="kategori">
                                                    <option value="<?php echo "$edit[id_kategori_produk]"; ?>"><?php echo "$edit[nama_kategori]"; ?></option>
                                                    <?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <?php echo "<img src='../assets/foto-produck/$edit[gambar]' width='200xp'>"; ?>
                                            </div>
                                        </div>
                                        <div class="hr-line-dashed"></div>
