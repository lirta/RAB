            ...
            <div id="wrapper">
                ...
                <div id="page-wrapper" class="gray-bg">
                    ...
                    <div class="row wrapper border-bottom white-bg page-heading">
                        <div class="col-lg-10">
                            <h2>Penambahan Data Bahan Kategori</h2>
                            <ol class="breadcrumb">
                                <li>
                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    <form class="form-horizontal m-t-md" action="bahan-kategori-add-proses.php" method="POST" enctype="multipart/form-data">
