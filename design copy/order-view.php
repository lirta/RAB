                                                            ...
                                                            while ($kastem = mysqli_fetch_assoc($qkastem)) { ?>
                                                                ...
                                                                <td class="text-right">
                                                                    <div class="btn-group">
                                                                        <?php
                                                                        echo "
                                                                        <a href='ukuran-add.php?id=$kolom[id_orderan]'  class='btn btn-white btn-xs'>UKURAN</a>
                                                                        <a href='bahan-add.php?id=$kolom[id_orderan]'  class='btn btn-white btn-xs'>BAHAN</a>
                                                                        <a href='order-detail.php?id=$kolom[id_orderan]'  class='btn btn-white btn-xs'>DETAIL</a> ";
                                                                        ?>
                                                                    </div>
                                                                </td>
                                                </tr>
