            ...
            <div id="wrapper">
                ...
                <div id="page-wrapper" class="gray-bg">
                    ...
                    <div class="row wrapper border-bottom white-bg page-heading">
                        <div class="col-lg-10">
                            <h2>Penambahan Data Hak Akses</h2>
                            <ol class="breadcrumb">
                                <li>
                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    <form class="form-horizontal m-t-md" action="akses-add-proses.php" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Kariawan</label>
                                            <div class="col-sm-6">
                                                <select class="form-control m-b" name="id">
                                                    <?php
                                                    $hasil = mysqli_query($koneksi, "SELECT * FROM kariawan ");
                                                    while ($kolom = mysqli_fetch_assoc($hasil)) {
                                                        echo "<option value='$kolom[id_kariawan]' >$kolom[nama_kariawan]</option>";
                                                    }
                                                    ?>
                                                </select>
                                            </div>
