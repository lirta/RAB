                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover dataTables-example">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $id = $_SESSION['id'];
                                                    $hasil = mysqli_query($koneksi, "SELECT * FROM konsumen where id_konsumen='$id'");
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php
                                                                echo "<a href='konsumen-edit.php?id=$kolom[id_konsumen]'  class='btn btn-primary btn-sm'>EDIT</a> ";
                                                                ?></td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
