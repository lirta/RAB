<ul class="nav metismenu" id="side-menu">
    <li class="nav-header">
        <div class="dropdown profile-element"> <span>
                <img alt="image" class="img-circle" src="<?php echo "../assets/foto-kariawan/$_SESSION[foto]"; ?>" width="100%" />
            </span>
            ...
            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                <li><a href="../kariawan/profile.php">Profile</a></li>
    ...
    <li>
        ...
        <ul class="nav nav-second-level collapse">
            <li><a href="../kariawan/kariawan_view.php">Kariawan</a></li>
            <li><a href="../kariawan/akses-view.php">Akses Sistem</a></li>
        </ul>
    </li>
    <li>
