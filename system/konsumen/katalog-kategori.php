            ...
            <div id="wrapper">
                ...
                <div id="page-wrapper" class="gray-bg">
                    ...
                    <div class="row wrapper border-bottom white-bg page-heading">
                        <div class="col-lg-10">
                            ...
                            <ol class="breadcrumb">
                                ...
                                ?>
                                        <li class="active">
                                            <strong><a href="<?php echo "katalog-kategori.php?id=$hk[id_kategori_produk]" ?>"><?php echo "$hk[nama_kategori]"; ?></a></strong>
                                        </li>
                                    <?php } else { ?>
                                        <li>
                    ...
                    <div class="wrapper wrapper-content animated fadeInRight">
                        <div class="row">
                            <?php
                            $hasil = mysqli_query($koneksi, "SELECT * FROM produk  where id_kategori_produk='$_GET[id]'   ");
                            $ketemu = mysqli_num_rows($hasil);
                            while ($kolom = mysqli_fetch_assoc($hasil)) {
                                if ($ketemu > 0) {
                                    $qkk = mysqli_query($koneksi, "SELECT * FROM  kategori_produk where id_kategori_produk='$kolom[id_kategori_produk]'");
                                    $hkk = mysqli_fetch_assoc($qkk);
                            ?>
                                    <div class="col-md-3">
                                        <div class="ibox">
