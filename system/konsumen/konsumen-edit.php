                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                ...
                                <?php
                                $hasil = mysqli_query($koneksi, "SELECT * FROM konsumen WHERE id_konsumen='$_SESSION[id]' ");
                                $edit = mysqli_fetch_assoc($hasil);
                                ?>
                                <div class="ibox-content">
                                    <form class="form-horizontal m-t-md" action="edit-profile-proses.php" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Nama</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" name="nama" value="<?php echo "$edit[nama_konsumen]"; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Alamat</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" name="alamat" value="<?php echo "$edit[alamat_konsumen]"; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" name="user" value="<?php echo "$edit[username]"; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
