<ul class="nav metismenu" id="side-menu">
    ...
    <li>
        <a href="order-view.php"><i class="fa fa-desktop"></i> <span class="nav-label">Orderan Proses</span></a>
    </li>
    <li>
        <a href="order-selesai-view.php"><i class="fa fa-desktop"></i> <span class="nav-label">Orderan Selesai</span></a>
    </li>
</ul>