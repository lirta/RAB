            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="ibox-content">
                        <form class="m-t" role="form" action="assets/login/proses-login-konsumen.php" method="POST">
                            ...
                            <a class="btn btn-sm btn-white btn-block" href="registrasi.php">Create an account</a>
                        </form>
                        <p class="m-t">
